    ...
    return(
        <div className="w-full flex flex-col ">
            <div className="overflow-hidden relative mb-3">
                <svg className="w-5  text-black absolute left-0 pointer-none  flex items-center   h-full ml-2" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5">
                ...
                <input type="email" className="w-full border rounded-3xl p-2 pl-8 pb-2.5  outline-none " placeholder="something@example.com"></input>
            </div>
            <div className="relative flex-row flex mb-3">
                ...
                <input type={visible ? 'text' : 'password'} className="w-full border rounded-3xl p-2 pb-2.5 pl-8  outline-none " placeholder="password"></input>
